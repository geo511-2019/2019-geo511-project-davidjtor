...
##### To download the data that is being stored on another server, we must remember to install the 'rnpn' package from github and put in the correct 'network id'
...
##### The table above shows the proportion of observations for each tree. This helps show what trees contributed to most of the observations.
...
##### The table above shows the variance in observations for the same species of trees and how they differ from month to month. This shows that even though students are looking at the same tree, they're opinion is different.
